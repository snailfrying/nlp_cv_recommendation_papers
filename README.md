...
2. 励志根据时间线与逻辑发展联系去介绍papers原理和代码实践。
3. 分析理解三个领域的发展和之间的技术联系与应用。

###### :imp: 原理介绍

1. 现阶段papers梳理完成，并且会跟着各个领域发展，更新重点papers。
2. 后续会根据各个邻域的技术联系和时间线去分析paper，即带你阅读paper。

######  :imp: 代码实践

1. 根据原理介绍，进行代码实践，即根据paper逻辑线，一步一步实现。
2. 并根据各个邻域技术实践方式总结，其联系与差异。
...
**注**：由于目录多，可下载chrome的插件**Octotree**,进行友好观看。
...
​	 如果您有任何问题，可发送邮箱： snailfrying@gmail.com.
